...
var ToDoList = (function (_super) {
    ...
    function ToDoList(props) {
        ...
        _this.addItem = function (event) {
            ...
            _this.setState({
                list: __spreadArrays(_this.state.list, [
                    {
                        value: value,
                        active: true,
                        id: _this.currentId++
        ...
        _this.itemClick = function (id) { return function () {
            var itemIndex = _this.state.list.findIndex(function (item) { return item.id === id; });
            var item = _this.state.list[itemIndex];
            _this.setState(function (myState) { return ({
                list: __spreadArrays(myState.list.slice(0, itemIndex), [
                    __assign(__assign({}, item), { active: !item.active })
                ], myState.list.slice(itemIndex + 1))
            }); });
        }; };
        _this.setFilter = function (type) { return function () {
            _this.setState({
                activeFilter: type
            });
        }; };
    ...
    ToDoList.prototype.render = function () {
        ...
        return (React.createElement("div", null,
            React.createElement("h1", { className: 'name' }, "TO-DO List"),
            React.createElement("div", { className: "buttons" },
                React.createElement("button", { onClick: this.setFilter('all'), className: 'btn' }, "All"),
                React.createElement("button", { onClick: this.setFilter('active'), className: 'btn' }, "Active"),
                React.createElement("button", { onClick: this.setFilter('done'), className: 'btn' }, "Done")),
            React.createElement("form", { onSubmit: this.addItem },
                React.createElement("input", { type: 'text', ref: this.input, className: 'input' }),
                React.createElement("button", { type: 'submit', className: 'btn' }, "Add")),
            React.createElement("ul", null, this.state.list
                ...
                .map(function (item) { return (React.createElement("li", { key: item.id, onClick: _this.itemClick(item.id), className: item.active ? 'active' : 'done' }, item.value)); }))));
    };
    return ToDoList;
}(React.Component));
